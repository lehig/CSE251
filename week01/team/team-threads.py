...
if __name__ == '__main__':
    ...
    threads = []
    num_thread = 10
    range_thread = range_count // num_thread

    for i in range(10):
        thread_start = start + (range_thread * i)
        thread_end = thread_start + range_thread
        thread = threading.Thread(target=search, args=(thread_start, thread_end))
